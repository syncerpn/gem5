...
# parser.add_option("-a",  "--workload-args",  type="string", default="classifier train /home/nghiant/git/darknet/data/cifar.data /home/nghiant/git/darknet/cfg/cifar.cfg", help="workload arguments")
...
parser.add_option("-c",  "--mesh-col",       type="int",    default=3, help="mesh max column")
