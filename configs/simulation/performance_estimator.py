...
parser.add_argument('--split_rate', type=int, default=9, help='total epochs to run')
parser.add_argument('--dataset_file', default='/home/nghiant/git/gem5/dataset_2x3_all.txt', help='dataset')
#output
parser.add_argument('--cv_dir', default='pe_model_2x3/test_9', help='checkpoint directory (models and logs are saved here)')
